...
| 8e | External reference URNs (§18) | cited statutes resolve to `<Remissao xlink:href="urn:lex:…">`; **all 125 existing goldens byte-identical**; suite green with no `linkertool`, and green again with the binary at `/usr/local/bin/linkertool` |
